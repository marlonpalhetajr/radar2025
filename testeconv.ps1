...
$arquivoExcel = Get-ChildItem -Path "$pastaExcel\1 *" -Filter "Tabela 1*.xlsx" | Select-Object -First 1
$arquivoHTML = Get-ChildItem -Path "$pastaHTML\1-*" -Filter "tabela-1*.htm" | Select-Object -First 1
